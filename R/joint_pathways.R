...
joint_pathways <- function(meta_pathways,protein_kegg_pathways_all,species,dir.file){
  ...
  pro_path <- protein_kegg_pathways_all[,c(2,5)]
  ...
  f3_name <- paste("Protein-metabolite Joint pathways 01","(",species,")",".png")
  ...
  f4_name <- paste("Protein-metabolite Joint pathways 02","(",species,")",".png")
